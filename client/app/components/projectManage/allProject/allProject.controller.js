...
import allProject from "../allProject.html";
import imgLoading from '../images/loading.gif'
export default class AllProjectController {
    constructor(NgTableParams, ServiceProjectManage, $uibModal, modalInstance, $scope) {
            'ngInject';
                ...
                controller: function(NgTableParams, ServiceProjectManage) {
                    ...
                    $ctrl.tableParamsusers = new $ctrl.NgTableParams({
                        ...
                        getData: ($defer, params) => {
                            ...
                            // console.log(_this.ServiceProjectManage.getUsersFromProject(formData))
